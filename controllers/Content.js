...
exports.getAllBuyFaq = async (req, res) => {
    try {
        ...
        console.error("Error fetching buyer FAQs:", error);
        res.status(500).json({
            success: false,
            message: "Error fetching buyer FAQs",
            error: error.message,
        });
    }
};
exports.getAllSellerFaq = async (req, res) => {
    try {
        const allSellFaq = await SellerFAQ.find();

        res.status(200).json({
            success: true,
            message: "All Seller FAQs retrieved successfully",
            data: allSellFaq,
        });
    } catch (error) {
        ...
        res.status(500).json({
            success: false,
            message: "Error fetching Seller FAQs",
            error: error.message,
        });
    }
};  
exports.getAllMainSlider = async (req, res) => {
    try {
        const allMainSlider = await mainSlider.find();

        res.status(200).json({
            success: true,
            message: "All Main Slider retrieved successfully",
            data: allMainSlider,
        });
    } catch (error) {
        console.error("Error fetching Main Slider:", error);
        res.status(500).json({
            success: false,
            message: "Error fetching Main Slider",
            error: error.message,
        });
    }
};  
exports.getAllCompanySlider = async (req, res) => {
    try {
        const allComapnySlider = await CompanySlider.find();

        res.status(200).json({
            success: true,
            message: "All Comapny Slider retrieved successfully",
            data: allComapnySlider,
        });
    } catch (error) {
        console.error("Error fetching Comapny Slider:", error);
        res.status(500).json({
            success: false,
            message: "Error fetching Comapny Slider",
            error: error.message,
        });
    }
};  
exports.getAllCounteryWeWillDeal = async (req,res)=>{
    try {
        const allCountry = await Countery.find();

        res.status(200).json({
            success: true,
            message: "All Comapny we Supply retrieved successfully",
             allCountry,
        });
    } catch (error) {
        ...
        res.status(500).json({
            success: false,
            message: "Error fetching Comapny",
            error: error.message,
        });
    }
}
exports.getAllContent = async (req,res)=>{
    try {
        ...
        res.status(500).json({
            success: false,
            message: "Error fetching All Content",
            error: error.message,
        });
    }
}
exports.getTestinomial = async (req,res)=>{
    try {
        const alltestinomail = await Testimonial.find();

        res.status(200).json({
            success: true,
            message: "All testinomail retrieved successfully",
            alltestinomail,
        });
    } catch (error) {
        console.error("Error fetching All testinomail:", error);
        res.status(500).json({
            success: false,
            message: "Error fetching All testinomail",
            error: error.message,
        });
    }
}
exports.getAllSalesSlider = async (req,res)=>{
    try {
        const allSalesSlider = await SalesSlider.find();

        res.status(200).json({
            success: true,
            message: "All SalesSlider retrieved successfully",
            allSalesSlider,
        });
    } catch (error) {
        console.error("Error fetching All SalesSlider:", error);
        res.status(500).json({
            success: false,
            message: "Error fetching All SalesSlider",
            error: error.message,
        });
    }
}
